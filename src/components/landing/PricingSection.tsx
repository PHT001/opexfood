  ...
  return (
    <section id="tarifs" className="relative py-16 sm:py-20 overflow-hidden">
      ...
      <Container>
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch overflow-visible">
          {pricingModules.map((tier, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Colored header */}
                <div
                  className={`relative bg-gradient-to-r ${style.gradient} px-6 py-5 flex items-center gap-3 min-h-[88px] rounded-t-2xl transition-opacity duration-300 ${
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/70">{tier.subtitle}</p>
                  </div>
                </div>

                {/* Body */}
                <div className={`p-6 flex flex-col flex-1 transition-opacity duration-300 ${isSelected ? "opacity-50" : ""}`}>
                  {/* Price */}
                  <div className="flex items-center gap-3">
                    <div className="flex items-baseline gap-1">
                      {showDiscount && (
                        <span className="text-xl font-bold text-slate-300 line-through mr-1">
                          {isAnnual ? tier.priceAnnual : tier.price}
                        </span>
                      )}
