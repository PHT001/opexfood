        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {activeModules.map((m) => {
            ...
            return (
              <div
                key={m.id}
                className="glass-card rounded-2xl p-4 flex items-start gap-3 border-l-4"
                style={{ borderLeftColor: m.color.replace("text-", "").includes("orange") ? "#ea580c" : undefined }}
              >
                ...
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100/80 text-green-700 glass-badge">
                  Actif
                </span>
              </div>
            );
            ...
            {availableModules.map((m) => {
              ...
              return (
                <Link
                  ...
                  className="glass-card glass-card-hover rounded-2xl p-4 flex items-start gap-3 group"
                >
                  <div className="w-9 h-9 rounded-lg bg-white/60 flex items-center justify-center shrink-0 group-hover:bg-orange-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      A partir de {m.priceAnnual} \u20AC/mois
                    </p>
                  </div>
