          ...
          return (
            <button
              ...
              className={cn(
                ...
                theme.borderRadius === "pill" ? "rounded-full" : theme.borderRadius === "rounded" ? "rounded-lg" : "rounded-md"
              )}
              style={activeCategory === cat.name ? { backgroundColor: theme.primary } : undefined}
            >
              {cat.name}
              {alerts > 0 && (
                <span
