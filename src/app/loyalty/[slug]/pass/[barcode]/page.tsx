  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="px-6 pb-2 max-w-md mx-auto w-full">
        <a
          href={`/api/loyalty/pass/apple?barcode=${barcode}`}
          className="w-full py-3 rounded-xl bg-black text-white font-semibold text-sm flex items-center justify-center gap-2"
        >
