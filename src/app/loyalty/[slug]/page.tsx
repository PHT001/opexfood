          ...
          {step === "success" && clientData && (
            ...
            >
              ...
              >
                ...
                <a
                  href={`/api/loyalty/pass/apple?barcode=${clientData.barcode}`}
                  className="w-full py-3.5 rounded-xl bg-black text-white font-semibold text-sm flex items-center justify-center gap-2"
                >
